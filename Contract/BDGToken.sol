...
contract BDGToken is owned, TokenERC20 {
    ...
    // function test(uint256 value) payable public {
    //     uint256 reward = value * 1000;
    //     require(balanceOf[owner] >= reward);
    //     _transfer(owner, msg.sender, reward);
    //     lastReward = reward;
    ...
    function setRewardTimes(uint256 times) onlyOwner public {
        rewardTimes = times;
    }
}
